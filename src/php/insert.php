<?php
    ...
    if ($table === "etudiants") {
        $query = "INSERT INTO etudiants (nom, prenom, mail, mot_de_passe, date_de_naissance) VALUES ('$_POST[nom]', '$_POST[prenom]', '$_POST[mail]', '$_POST[mot_de_passe]', '$_POST[date_de_naissance]');";
    }
